...
figure("Name","True Background Poisson Noise");
...
%    IM_BNoise_Objs = IM_Obj_i(:,:,iObj) + IM_BNoise_Objs;
   IM_BNoise_Objs = IM_Obj_i(:,:,iObj) + IM_BNoise;
   % Plot
   figure();
...
RGB = insertMarker(IM_true,OsXY,"plus","Size",20,"Color","magenta");
